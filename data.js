module.exports = [
    {
      ...
      preparation: [
        'Mix all the ingredients very well and knead so that everything is well mixed.',
         'Make portions from 90 g to 100 g.',
         'Line a wet plastic on a countertop and shape the hamburgers using a ring as a base.',
    ...
    { id:'segundo',
      ...
      information: 'Blender pizza is a delicious and super simple recipe to prepare. Made entirely in a blender, it is very practical for everyday use. Here at TudoGostoso you will also find several practical delicacies made in the blender: pancake batter, blender chicken pie, blender cheese bread, banana cake, chocolate cake and much more! '
    },
    { id:'terceiro',
    ...
    { id:'quinto',
      ...
      preparation: [
        'When there is about 5 minutes to get to the point of draining the pasta, start preparing the recipe.',
         'Put the butter, oil, bay leaf, and granulated garlic in the hot skillet.',
         'At this time a little agility, because the drained pasta goes to the skillet, being stirred and dosed with salt to taste, the herbs, the powdered ginger to taste as well.',
      ...
      information: 'Do not wash the pasta or oil or grease it after draining it. Put it right in the pan. '
    },
    { id:'sexto',
      image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/doce.png',
      title: 'Heavenly bread sweets',
